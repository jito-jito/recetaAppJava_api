...
public class DataSeed {
    ...
    private static final String AUTOR_ADMIN  = "admin";
    private static final String UNIDAD_GRAMOS = "gramos";
    private static final String UNIDAD_UNIDAD  = "unidad";
    ...
    public static List<Receta> generarRecetas() {
        ...
        lista.add(new Receta(
                ...
                imagenes, new ArrayList<>(), AUTOR_ADMIN, true,
        ...
        lista.add(new Receta(
                ...
                new ArrayList<>(), new ArrayList<>(), AUTOR_ADMIN, true,
                new Ingrediente("Espaguetis", 400.0, UNIDAD_GRAMOS),
                new Ingrediente("Huevos", 3.0, "unidades"),
                new Ingrediente("Queso Pecorino", 100.0, UNIDAD_GRAMOS),
                new Ingrediente("Guanciale", 150.0, UNIDAD_GRAMOS)));
        ...
        lista.add(new Receta(
                ...
                new Ingrediente("Pepino", 1.0, UNIDAD_UNIDAD),
                new Ingrediente("Queso Feta", 200.0, UNIDAD_GRAMOS),
                new Ingrediente("Aceitunas Kalamata", 50.0, UNIDAD_GRAMOS)));
        ...
        lista.add(new Receta(
                ...
                new ArrayList<>(), new ArrayList<>(), AUTOR_ADMIN, true,
                new Ingrediente("Arroz Arborio", 300.0, UNIDAD_GRAMOS),
                new Ingrediente("Champiñones", 250.0, UNIDAD_GRAMOS),
                new Ingrediente("Caldo de Verduras", 1.0, "litro"),
                new Ingrediente("Queso Parmesano", 80.0, UNIDAD_GRAMOS)));
        ...
        lista.add(new Receta(
                ...
                new Ingrediente("Pimiento verde", 1.0, UNIDAD_UNIDAD),
                new Ingrediente("Pepino", 0.5, UNIDAD_UNIDAD),
        ...
        lista.add(new Receta(
                ...
                new ArrayList<>(), new ArrayList<>(), AUTOR_ADMIN, true,
                new Ingrediente("Arroz para sushi", 500.0, UNIDAD_GRAMOS),
                new Ingrediente("Salmón crudo grado sushi", 200.0, UNIDAD_GRAMOS),
