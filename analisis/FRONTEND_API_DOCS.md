...
Permite a los usuarios leer opiniones (público) y dejar opiniones (autenticado) acerca de una receta específica.

**A. Obtener Comentarios (GET) [PÚBLICO]**
Devuelve una lista con todos los comentarios de una receta, ordenados del más reciente al más antiguo. No requiere Token.
```http
...
**A. Obtener Valoraciones (GET) [PÚBLICO]**
No requiere Token. Retorna todos los puntajes otorgados al plato.
```http
